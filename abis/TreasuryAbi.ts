export const TreasuryAbi = [
    ...
    inputs: [
      {
        name: "params",
        type: "tuple[]",
        internalType: "struct TreasuryStorage.UnwrapParams[]",
        components: [
          {
            name: "fuelCellId",
            type: "uint256",
  ...
  {
    type: "error",
    name: "CannotGiveYieldForFutureJourney",
    inputs: [],
  },
  {
    type: "error",
    name: "InvalidJourneyForFuelCell",
    inputs: [
      {
        name: "fuelCellId",
        type: "uint256",
  ...
  {
    type: "error",
    name: "YieldAlreadyDistributed",
    inputs: [],
  },
  {
    type: "error",
    name: "YieldPhaseNotStarted",
    inputs: [],
  },
] as const;
